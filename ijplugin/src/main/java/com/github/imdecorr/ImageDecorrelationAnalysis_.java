...
public class ImageDecorrelationAnalysis_ implements PlugIn {
	...
	public void run(String arg0) {
		...
		compute.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if (Nr < 10) {
						Nr = 10;
						NrField.setText(Integer.toString(10));
					}
					if (Ng < 5) {
						Ng = 5;
						NgField.setText(Integer.toString(5));
					}
					if (rmin < 0) {
						rmin = 0;
		...
		subPanel2.add(NrLabel);
		subPanel2.add(NrField);
		subPanel2.add(NgLabel);
		subPanel2.add(NgField);
		subPanel3.add(doPlotCB);
		subPanel3.add(batchStackCB);
		subPanel3.add(batchCB);
